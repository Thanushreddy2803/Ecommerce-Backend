...
import com.project.ecommerce_backend.model.Size;
...
public class CreateProductRequest {
    ...
    public CreateProductRequest(String title, String description, int price, int discountedPrice, int discountedPercent, int quantity, String brand, String color, Set<Size> size, String imageUrl, String topLavelCategory, String secondLavelCategory, String thirdLavelCategory) {
        this.title = title;
        this.description = description;
        this.price = price;
        this.discountedPrice = discountedPrice;
